...
def test_local_worker_forced_to_cloud_when_midgard_off():
    ...
    wp = WorkerPlan("midgard.primary", "coder", "task", [], "local")
...
def test_cloud_worker_forced_to_local_when_asgard_off():
    ...
    wp = WorkerPlan("asgard.primary", "coder", "task", [], "cloud")
...
def test_normal_routing_when_both_enabled():
    ...
    local_wp = WorkerPlan("midgard.primary", "coder", "task", [], "local")
    cloud_wp = WorkerPlan("asgard.primary", "coder", "task", [], "cloud")
